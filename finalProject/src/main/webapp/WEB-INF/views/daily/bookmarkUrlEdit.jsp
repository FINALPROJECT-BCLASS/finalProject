...
<body>
    ...
    <div class="right-area">
        <div>
            <form action="editBookmarkUrl.do" id="updateUrl">
                <span class="pSubject">Add Bookmark URL</span>
                <input type="hidden" id="bl_no" name="bl_no" value="${bmUrl.bl_no }">
                <input type="hidden" id="ub_no" name="ub_no" value="${bmUrl.ub_no }">
                ...
                <div class="button-area">
                    ...
                    <button type="button" onclick="url_submit()">Edit</button>
                </div>
            </form>
        </div>
    </div>
