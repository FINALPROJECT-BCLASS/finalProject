...
<head>
    ...
    .join-form-area{float: right;display: flex;justify-content: center; flex-direction: column; align-items: center; padding: 40px; width: 75%; background: #F3F3F3; }
    ...
    /* 공지 */
    .noticeText{float: right;margin:auto; width: 75%; background:#c2c2c2; border-radius: 0 0 5px 5px;  }
