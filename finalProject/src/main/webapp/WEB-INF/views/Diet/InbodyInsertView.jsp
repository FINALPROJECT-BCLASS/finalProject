		...
		<div class="rightArea">
			...
			<form action="InbodyInsert.do" method="post" >
				...
				<input type="hidden" value="${today }" id="In_date" name="inDate">
					<tr>
						<td>체중</td>
						<td><input type="text" id="In_weight" name="inWeight" required></td>
					</tr>
					<tr>
						<td>골격근량</td>
						<td><input type="text" id="In_muscle" name="inMuscle" required></td>
					</tr>
					<tr>
						<td>체지방량</td>
						<td><input type="text" id="In_fat" name="inFat" required> <button type="submit" class="default-btn b-yell">Add</button></td>
					</tr>
				</table>
			</form>
		</div>
